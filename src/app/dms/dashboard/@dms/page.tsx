export default function DocumentManagementSystem(){
    return(
        <div className="bg-[#fffff] text-[#112D4E] p-6 rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-1 transition duration-300 ease-in-out">
            <h3 className="text-lg font-bold text-center  ">Document Management System</h3>
            <div className="h-70 mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
